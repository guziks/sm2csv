...
public class SimpleScadaTagWriter extends CSVWriter {
    ...
    private static final String[] HEADER1 = {"", "", "", "Архив", "", "", "", "Шкала", "", "", "", "", "", "", "", "", "", "", "", "Границы", "", "", "", "Режим масштабирования", ""};
    private static final String[] HEADER2 = {"Имя группы", "Имя переменной", "Тип данных", "Тип архивации", "Тип тренда", "Зона нечувствительности", "Интервал архивации", "Имя шкалы", "Ед. измерения", "Минимум", "Максимум", "Описание", "Тип тега", "Адрес", "Имя ПК", "OPC-сервер", "Частота опроса тегов", "Формат", "Сдвиг", "ВА", "ВП", "НП", "НА", "Виз. минимум", "Виз. максимум"};
